...
export default function PendentePagamento() {
    return (
        <div className="w-full flex justify-center px-4">
            <div className="w-full lg:w-[50%]">
                <TituloPagina icone={<IconReceiptDollar />} descricao="Pagamento" />

                <Card icon={<IconExclamationCircle />} titulo="Pendende">
                    <div className="flex flex-col gap-5 p-2">
                        <div className="flex flex-col gap-2">
                            <span className="text-lg text-orange-500">O seu pagamento está pendente!</span>
