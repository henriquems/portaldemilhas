...
export function DataTable<TData, TValue>({columns, data, page, pageSize, totalCount, carregando}: DataTableProps<TData, TValue>) {
  ...
  return (
    <div>
      <div className="grid md:grid-cols-3 sm:grid-cols-1 gap-2 mb-2">
        <Input
        ...
        <Input
          ...
          value={(table.getColumn("dias")?.getFilterValue() as string) ?? ""}
          onChange={(event) =>
            table.getColumn("dias")?.setFilterValue(event.target.value)
          }
          className="max-w h-10 bg-gray-950 border-gray-800 !placeholder-slate-300 text-slate-300"
        />
        ...
        <Input
          ...
          onChange={(event) =>
            table.getColumn("valor")?.setFilterValue(event.target.value)
          }
          className="max-w h-10 bg-gray-950 border-gray-800 !placeholder-slate-300 text-slate-300"
        />
      </div>
