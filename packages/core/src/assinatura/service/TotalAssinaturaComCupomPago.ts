...
export default class TotalAssinaturaComCupomPago implements CasoDeUso<Entrada, number> {
    ...
    async executar(entrada: Entrada): Promise<number> {
        ...
        return this.repositorio.recuperarTotalAssinaturaComCupomPago(usuario);
    }
}